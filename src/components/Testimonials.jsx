  ...
  const testimonials = [
    {
      ...
      name: 'Mouad CHAOUNI',
      role: 'Patient',
      content: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas unde debitis minima maiores, veritatis, suscipit cupiditate dolores doloremque eligendi, fuga ipsa nam similique omnis pariatur totam tempora distinctio error illo!',
      rating: 5,
              ...
              <div key={testimonial.id} className='w-full flex-shrink-0 px-4'>
                <div className='bg-white p-8 rounded-3xl shadow-xl flex flex-col md:flex-row items-center'>
                  ...
                  <div className='md:w-2/3 md:pl-12'>
                    <div className='relative'>
                      <FaQuoteLeft className='text-sky-500 text-4xl absolute -top-2 -left-10' />
                    ...
                    <div className='flex items-center justify-between'>
                      ...
                      <div className='hidden md:flex space-x-2'>
                        ...
                        className='p-2 rounded-full bg-sky-100 text-sky-100 hover:bg-sky-200 transition-colors'>
                          <FaChevronLeft />
                        </button>
                        <button 
