...
const Tips = () => {
    ...
    const tips= [
      {
        ...
        content: 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptates mollitia nulla fugiat rerum nisi nam excepturi voluptatibus soluta, corporis praesentium aliquid sint magnam sed repellat sunt culpa voluptatum nemo. Dolorem!',
  ...
  return (
    <section id='tips' className="scroll-mt-20 mt-10 max-w-6xl mx-auto px-4 py-12`">
      <div className="text-center mb-12">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-3">Dental Care Tips</h2>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          minima quas amet porro, at quidem reiciendis nemo eveniet? Laborum, nam!
        </p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
        {tips.map((tip,index) => (
          ...
          className={`p-4 rounded-xl transition-all duration-300 flex flex-col items-center ${activeTip === index 
