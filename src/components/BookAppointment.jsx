...
import { FaCalendarAlt, FaChevronCircleRight, FaChevronRight, FaClock, FaPhone, FaTooth, FaUser } from "react-icons/fa";
    ...
    <div id='book' className="scroll-mt-20 min-h-screen bg-gradient-to-br from-sky-50 to-sky-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className='text-lg text-gray-600'>voluptatum ex voluptate non facilis enim dolores, dolor neque recusandae.</p>
        </div>
        <div className="mb-12">
          <div className="relative">
            <div className="absolute top-1/2 left-0 right-0 h-2 bg-gray-100 rounded-full z-0"></div>
            <div 
            className='absolute top-1/2 left-0 h-2 bg-gradient-to-br from-sky-400 to-sky-400 rounded-full z-10 transition-all duration-500'
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="relative">
                  ...
                  <FaClock className="absolute left-4 top-1/2 transform -translate-1/2 text-gray-400"/>
                  <FaChevronCircleRight className="absolute right-4 top-1/2 transform -translate-1/2 rotate-90 text-gray-400"/>
                </div>
                <div className="relative md:col-span-2">
                  ...
                  <FaTooth className="absolute left-4 top-1/2 transform -translate-1/2 text-gray-400"/>
                  <FaChevronCircleRight className="absolute right-4 top-1/2 transform -translate-1/2 rotate-90 text-gray-400"/>
                </div>
              </div>
            </div>
